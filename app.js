            ...
            request({
                ...
                function (error, response, body) {
                    ...
                    if (!error && response.statusCode == 200) {
                        ...
                        session.sendTyping();
                        session.send(`Hi ${d}! Welcome to GOtivation! Together, we’re going to motivate, educate, and encourage you along our fitness journey. Each day, I’ll send you motivation that is scientifically proven to help you succeed. I think you’re going to be excited about the transformation :)`)
